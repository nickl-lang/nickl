...
syn keyword nicklKeyword break cast continue do else fn for if in return struct while defer type_t array_t ptr_t tuple_t foreign string pub import here
syn keyword nicklType i8 i16 i32 i64 u16 u32 u64 u8 f32 f64 int float void bool
