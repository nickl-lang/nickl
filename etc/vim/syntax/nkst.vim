...
syn keyword nkstKeyword nullptr proc link const pub const import param call return context run var assign struct member if while addr deref export index
