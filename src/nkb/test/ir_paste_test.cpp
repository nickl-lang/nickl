...
extern "C" NK_EXPORT int64_t test_shouldFreeResources() {
    return 0;
}

extern "C" NK_EXPORT int64_t test_freeResources() {
    return 0;
}

extern "C" NK_EXPORT int64_t test_doStuff() {
    return 0;
}

extern "C" NK_EXPORT int64_t test_doMoreStuff() {
    return 0;
}
...
TEST_F(ir_paste, defer_scenario) {
    ...
    auto const ir = nkir_createProgram(&m_arena);
    ...
    auto const test_freeResources_ref =
        nkir_makeExternProcRef(ir, nkir_makeExternProc(ir, nk_cs2atom(""), nk_cs2atom("test_freeResources"), &proc_t));
    ...
    auto const test_doMoreStuff_ref =
        nkir_makeExternProcRef(ir, nkir_makeExternProc(ir, nk_cs2atom(""), nk_cs2atom("test_doMoreStuff"), &proc_t));
    ...
    nkir_emit(ir, nkir_make_call(ir, should_do_more_stuff_ref, test_freeResources_ref, {}));
    {
        ...
        *(int64_t *)nkir_getDataPtr(ir, cnst) = 0;
