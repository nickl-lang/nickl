...
#define nk_allocTn(alloc, T, N) (T *)nk_allocAligned((alloc), sizeof(T) * (N), alignof(T))
#define nk_freeTn(alloc, ptr, T, N) nk_freeAligned((alloc), (void *)(ptr), sizeof(T) * (N), alignof(T))
