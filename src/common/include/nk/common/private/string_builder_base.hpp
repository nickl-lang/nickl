#ifndef HEADER_GUARD_NK_COMMON_PRIVATE_STRING_BUILDER_BASE
#define HEADER_GUARD_NK_COMMON_PRIVATE_STRING_BUILDER_BASE
...
#endif // HEADER_GUARD_NK_COMMON_PRIVATE_STRING_BUILDER_BASE
